...
public class EducationalVideosEnglish extends AppCompatActivity implements View.OnClickListener {
    TextView yt1, yt2,yt3,yt4;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_educational_videos_english);
    ...
    public void onClick(View view) {
        if (view == yt1) {
            Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.youtube.com/watch?v=pTCgWVjB6UE"));
        ...
        if (view == yt3) {
            Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://youtu.be/w7y2zKb3iug"));
            startActivity(intent);
        }
        if (view == yt4) {
