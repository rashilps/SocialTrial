...
public class EducationalVideosMarathi extends AppCompatActivity implements View.OnClickListener{
    TextView yt1, yt2,yt3,yt4;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_educational_videos_marathi);
    ...
    public void onClick(View view) {
        ...
        if (view == yt4) {
            Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://youtu.be/UaBzJmv97eY"));
            startActivity(intent);
        }
    }
}